export const enUS = {
  ...
  connectionErrors: {
    ...
    apiDesc: "The SaySo Notebook API server could not be reached",
    ...
    docLink: "SaySo Notebook Documentation",
  ...
  sources: {
    ...
    batchAddToNotebook: "Add selected to notebook",
  ...
  chat: {
    ...
    notebookChat: "Notebook Chat",
    globalAsk: "Global Ask",
    globalAskDesc: "Search across all your knowledge base",
  },
  searchPage: {
    askAndSearch: "Ask and Search",
  ...
  memories: {
    browseTitle: "Browse Memories",
    searchPlaceholder: "Search your memories...",
    importSelected: "Import Selected",
    addFromMemory: "Add from Memory",
    episodicMemory: "Episodic Memory",
    eventLog: "Event Log",
    foresight: "Foresight",
    importSuccess: "Memories imported as sources",
    importError: "Failed to import memories",
    hubOffline: "Memory Hub is offline",
    importing: "Importing memories...",
    noMemories: "No memories available",
    noResults: "No memories found for this query",
    originBrowser: "Browser Capture",
  ...
  settings: {
    ...
    filesHelp: "Once your files are uploaded and processed, they are not required anymore. Most users should allow SaySo Notebook to delete uploaded files from the upload folder automatically.",
  ...
  advanced: {
    ...
    updateAvailableDesc: "A new version of SaySo Notebook is available.",
    upToDate: "Up to Date",
    unknown: "Unknown",
  ...
  models: {
    ...
    defaultAssignmentsDesc: "Configure which models to use for different purposes across SaySo Notebook",
    missingRequiredModels: "Missing required models: {models}. SaySo Notebook may not function properly without these.",
  ...
  apiKeys: {
    ...
    description: "Store API keys securely in the database to enable AI providers in SaySo Notebook.",
  ...
  studio: {
    title: "Studio",
    description: "Generate content from your sources",
    emptyState: "Studio outputs will appear here.",
    emptyStateDesc: "Add sources, then click to generate audio overviews, study guides, mind maps, and more!",
