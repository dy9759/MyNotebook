export const frFR = {
  ...
  connectionErrors: {
    ...
    apiDesc: "Le serveur API de SaySo Notebook est injoignable",
    ...
    docLink: "Documentation de SaySo Notebook",
  ...
  sources: {
    ...
    batchAddToNotebook: "Ajouter la sélection au carnet",
  ...
  chat: {
    ...
    notebookChat: "Chat du carnet",
    globalAsk: "Question globale",
    globalAskDesc: "Rechercher dans toute votre base de connaissances",
  },
  searchPage: {
  ...
  memories: {
    browseTitle: "Parcourir les souvenirs",
    searchPlaceholder: "Rechercher dans vos souvenirs...",
    importSelected: "Importer la sélection",
    addFromMemory: "Ajouter depuis la mémoire",
    episodicMemory: "Mémoire épisodique",
    eventLog: "Journal des événements",
    foresight: "Prospective",
    importSuccess: "Souvenirs importés comme sources",
    importError: "Échec de l'importation des souvenirs",
    hubOffline: "Le hub de mémoire est hors ligne",
    importing: "Importation des souvenirs...",
    noMemories: "Aucun souvenir disponible",
    noResults: "Aucun souvenir trouvé pour cette recherche",
    originBrowser: "Capture du navigateur",
    originClaudeCode: "Claude Code",
    originEvermemo: "EverMemo",
    today: "Aujourd'hui",
    yesterday: "Hier",
  },
  podcasts: {
  ...
  settings: {
    ...
    filesHelp: "Une fois vos fichiers téléchargés et traités, ils ne sont plus nécessaires. La plupart des utilisateurs devraient autoriser SaySo Notebook à supprimer automatiquement les fichiers du dossier de téléchargement.",
  ...
  advanced: {
    ...
    updateAvailableDesc: "Une nouvelle version de SaySo Notebook est disponible.",
    upToDate: "À jour",
    unknown: "Inconnu",
  ...
  models: {
    ...
    defaultAssignmentsDesc: "Configurez quels modèles utiliser pour les différents usages d'SaySo Notebook",
    missingRequiredModels: "Modèles requis manquants : {models}. SaySo Notebook pourrait ne pas fonctionner correctement sans eux.",
  ...
  apiKeys: {
    ...
    description: "Stockez les clés API de manière sécurisée dans la base de données pour activer les fournisseurs d'IA dans SaySo Notebook.",
  ...
  studio: {
    title: "Studio",
    description: "Générer du contenu à partir de vos sources",
    emptyState: "Les sorties du Studio apparaîtront ici.",
    emptyStateDesc: "Ajoutez des sources, puis cliquez pour générer des résumés audio, des guides d'étude, des cartes mentales et plus encore !",
