export const ptBR = {
  ...
  connectionErrors: {
    ...
    apiDesc: "O servidor da API do SaySo Notebook não pôde ser alcançado",
    ...
    docLink: "Documentação do SaySo Notebook",
  ...
  sources: {
    ...
    batchAddToNotebook: "Adicionar selecionados ao caderno",
  ...
  chat: {
    ...
    notebookChat: "Chat do Caderno",
    globalAsk: "Pergunta Global",
    globalAskDesc: "Pesquisar em toda a sua base de conhecimento",
  },
  searchPage: {
    askAndSearch: "Perguntar e Buscar",
  ...
  memories: {
    browseTitle: "Explorar Memórias",
    searchPlaceholder: "Pesquisar suas memórias...",
    importSelected: "Importar Selecionadas",
    addFromMemory: "Adicionar da Memória",
    episodicMemory: "Memória Episódica",
    eventLog: "Registro de Eventos",
    foresight: "Previsão",
    importSuccess: "Memórias importadas como fontes",
    importError: "Falha ao importar memórias",
    hubOffline: "O Hub de Memórias está offline",
    importing: "Importando memórias...",
    noMemories: "Nenhuma memória disponível",
    noResults: "Nenhuma memória encontrada para esta pesquisa",
    originBrowser: "Captura do Navegador",
  ...
  settings: {
    ...
    filesHelp: "Uma vez que seus arquivos são enviados e processados, eles não são mais necessários. A maioria dos usuários deve permitir que o SaySo Notebook exclua arquivos enviados da pasta de upload automaticamente.",
  ...
  advanced: {
    ...
    updateAvailableDesc: "Uma nova versão do SaySo Notebook está disponível.",
    upToDate: "Atualizado",
    unknown: "Desconhecido",
  ...
  models: {
    ...
    defaultAssignmentsDesc: "Configure quais modelos usar para diferentes propósitos no SaySo Notebook",
    missingRequiredModels: "Modelos obrigatórios ausentes: {models}. O SaySo Notebook pode não funcionar corretamente sem eles.",
  ...
  apiKeys: {
    ...
    description: "Armazene chaves de API com segurança no banco de dados para habilitar provedores de IA no SaySo Notebook.",
  ...
  studio: {
    title: "Studio",
    description: "Gerar conteúdo a partir das suas fontes",
    emptyState: "As saídas do Studio aparecerão aqui.",
    emptyStateDesc: "Adicione fontes e clique para gerar resumos de áudio, guias de estudo, mapas mentais e mais!",
    comingSoon: "Em breve",
    audioOverview: "Resumo de Áudio",
