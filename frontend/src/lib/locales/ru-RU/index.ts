export const ruRU = {
  ...
  connectionErrors: {
    ...
    apiDesc: "API-сервер SaySo Notebook недоступен",
    ...
    docLink: "Документация SaySo Notebook",
  ...
  sources: {
    ...
    batchAddToNotebook: "Добавить выбранное в блокнот",
  ...
  chat: {
    ...
    notebookChat: "Чат блокнота",
    globalAsk: "Глобальный вопрос",
    globalAskDesc: "Поиск по всей базе знаний",
  },
  searchPage: {
    askAndSearch: "Запрос и поиск",
  ...
  memories: {
    browseTitle: "Обзор воспоминаний",
    searchPlaceholder: "Поиск по воспоминаниям...",
    importSelected: "Импортировать выбранные",
    addFromMemory: "Добавить из памяти",
    episodicMemory: "Эпизодическая память",
    eventLog: "Журнал событий",
    foresight: "Предвидение",
    importSuccess: "Воспоминания импортированы как источники",
    importError: "Не удалось импортировать воспоминания",
    hubOffline: "Хаб памяти не в сети",
    importing: "Импорт воспоминаний...",
    noMemories: "Нет доступных воспоминаний",
    noResults: "По этому запросу воспоминания не найдены",
    originBrowser: "Захват из браузера",
  ...
  settings: {
    ...
    filesHelp: "После загрузки и обработки файлы больше не нужны. Большинству пользователей следует разрешить SaySo Notebook автоматически удалять загруженные файлы из папки загрузок.",
  ...
  advanced: {
    ...
    updateAvailableDesc: "Доступна новая версия SaySo Notebook.",
  ...
  models: {
    ...
    defaultAssignmentsDesc: "Настройте, какие модели использовать для различных задач в SaySo Notebook",
    missingRequiredModels: "Отсутствуют необходимые модели: {models}. SaySo Notebook может работать некорректно без них.",
  ...
  apiKeys: {
    ...
    description: "Храните API-ключи в базе данных для безопасного подключения провайдеров ИИ в SaySo Notebook.",
  ...
  studio: {
    title: "Студия",
    description: "Создание контента из ваших источников",
    emptyState: "Результаты студии появятся здесь.",
    emptyStateDesc: "Добавьте источники, затем нажмите для создания аудиообзоров, учебных пособий, ментальных карт и многого другого!",
    comingSoon: "Скоро",
    audioOverview: "Аудиообзор",
    presentation: "Презентация",
    videoSummary: "Видеообзор",
