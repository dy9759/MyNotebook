export const zhTW = {
  ...
  connectionErrors: {
    ...
    apiDesc: "無法存取 SaySo Notebook API 伺服器",
    dbTitle: "資料庫連線失敗",
  ...
  sources: {
    ...
    textType: "文字",
    memoryType: "記憶",
    addToNotebook: "新增到筆記本",
    searchSources: "搜尋來源...",
    selectedCount: "已選擇 {count} 項",
    batchAddToNotebook: "新增選取項到筆記本",
  ...
  memories: {
    browseTitle: "瀏覽記憶",
    searchPlaceholder: "搜尋您的記憶...",
    importSelected: "匯入所選",
    addFromMemory: "從記憶新增",
    episodicMemory: "情節記憶",
    eventLog: "事件日誌",
    foresight: "前瞻",
    importSuccess: "記憶已匯入為來源",
    importError: "匯入記憶失敗",
    hubOffline: "記憶中心已離線",
    importing: "正在匯入記憶...",
    noMemories: "沒有可用的記憶",
    noResults: "未找到符合此查詢的記憶",
    originBrowser: "瀏覽器擷取",
  ...
  advanced: {
    ...
    updateAvailableDesc: "SaySo Notebook 的新版本可用。",
    upToDate: "已是最新",
    unknown: "未知",
  ...
  models: {
    ...
    defaultAssignmentsDesc: "設定用於 SaySo Notebook 不同用途的預設模型",
    missingRequiredModels: "缺少必需的模型：{models}。如果没有這些模型，SaySo Notebook 可能無法正常運行。",
  ...
  apiKeys: {
    ...
    description: "將 API 金鑰安全地儲存在資料庫中，以在 SaySo Notebook 中啟用 AI 服務商。",
  ...
  studio: {
    title: "工作室",
    description: "從您的來源產生內容",
    emptyState: "工作室輸出將顯示在此處。",
    emptyStateDesc: "新增來源後，點擊即可產生音訊概覽、學習指南、心智圖等！",
    comingSoon: "即將推出",
    audioOverview: "音訊概覽",
    presentation: "簡報",
    videoSummary: "影片概覽",
