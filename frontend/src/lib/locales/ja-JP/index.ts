export const jaJP = {
  ...
  connectionErrors: {
    ...
    apiDesc: "SaySo Notebook APIサーバーに到達できませんでした",
  ...
  sources: {
    ...
    textType: "テキスト",
    memoryType: "メモリ",
    addToNotebook: "ノートブックに追加",
    searchSources: "ソースを検索...",
    selectedCount: "{count} 件選択中",
    batchAddToNotebook: "選択したアイテムをノートブックに追加",
  ...
  chat: {
    ...
    notebookChat: "ノートブックチャット",
    globalAsk: "グローバル質問",
    globalAskDesc: "すべてのナレッジベースを検索",
  },
  searchPage: {
    askAndSearch: "質問と検索",
    chooseAMode: "モードを選択",
  ...
  memories: {
    browseTitle: "メモリーを閲覧",
    searchPlaceholder: "メモリーを検索...",
    importSelected: "選択をインポート",
    addFromMemory: "メモリーから追加",
    episodicMemory: "エピソード記憶",
    eventLog: "イベントログ",
    foresight: "フォーサイト",
    importSuccess: "メモリーをソースとしてインポートしました",
    importError: "メモリーのインポートに失敗しました",
    hubOffline: "メモリーハブがオフラインです",
    importing: "メモリーをインポート中...",
    noMemories: "利用可能なメモリーがありません",
    noResults: "この検索に一致するメモリーが見つかりません",
    originBrowser: "ブラウザキャプチャ",
  ...
  settings: {
    ...
    filesHelp: "ファイルがアップロードされて処理されると、ファイル自体は不要になります。ほとんどのユーザーはSaySo Notebookがアップロードフォルダから自動的にファイルを削除することを許可すべきです。",
  ...
  advanced: {
    ...
    updateAvailableDesc: "SaySo Notebookの新しいバージョンが利用可能です。",
    upToDate: "最新版です",
    unknown: "不明",
  ...
  models: {
    ...
    defaultAssignmentsDesc: "SaySo Notebook全体で異なる目的に使用するモデルを設定",
    missingRequiredModels: "必須モデルがありません: {models}。これらがないとSaySo Notebookが正しく機能しない可能性があります。",
  ...
  apiKeys: {
    ...
    description: "APIキーをデータベースに安全に保存し、SaySo NotebookでAIプロバイダーを有効にします。",
  ...
  studio: {
    title: "スタジオ",
    description: "ソースからコンテンツを生成",
    emptyState: "スタジオの出力がここに表示されます。",
    emptyStateDesc: "ソースを追加してクリックすると、音声概要、学習ガイド、マインドマップなどを生成できます！",
    comingSoon: "近日公開",
    audioOverview: "音声概要",
