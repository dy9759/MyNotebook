export const zhCN = {
  ...
  connectionErrors: {
    ...
    apiDesc: "无法访问 SaySo Notebook API 服务器",
    dbTitle: "数据库连接失败",
  ...
  memories: {
    ...
    eventLog: "事件日志",
    foresight: "前瞻记忆",
    importSuccess: "记忆已导入为资料来源",
    importError: "导入记忆失败",
    hubOffline: "Memory Hub 离线",
    importing: "正在导入记忆...",
    noMemories: "暂无可用记忆",
    noResults: "未找到匹配的记忆",
    originBrowser: "浏览器捕获",
  ...
  models: {
    ...
    defaultAssignmentsDesc: "配置用于 SaySo Notebook 不同用途的默认模型",
    missingRequiredModels: "缺少必需的模型：{models}。如果没有这些模型，SaySo Notebook 可能无法正常运行。",
  ...
  apiKeys: {
    ...
    description: "将 API 密钥安全地存储在数据库中，以在 SaySo Notebook 中启用 AI 服务商。",
  ...
  studio: {
    title: "工作室",
    description: "从您的来源生成内容",
    emptyState: "工作室输出将显示在此处。",
    emptyStateDesc: "添加来源后，点击即可生成音频概览、学习指南、思维导图等！",
    comingSoon: "即将推出",
    audioOverview: "音频概览",
    presentation: "演示文稿",
    videoSummary: "视频概览",
