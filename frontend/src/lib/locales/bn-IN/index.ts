export const bnIN = {
  ...
  sources: {
    ...
    batchAddToNotebook: "নির্বাচিত আইটেম নোটবুকে যোগ করুন",
  ...
  chat: {
    ...
    notebookChat: "নোটবুক চ্যাট",
    globalAsk: "গ্লোবাল প্রশ্ন",
    globalAskDesc: "আপনার সমস্ত জ্ঞানভাণ্ডারে অনুসন্ধান করুন",
  },
  searchPage: {
    askAndSearch: "জিজ্ঞাসা ও অনুসন্ধান",
  ...
  memories: {
    browseTitle: "স্মৃতি ব্রাউজ করুন",
    searchPlaceholder: "আপনার স্মৃতি অনুসন্ধান করুন...",
    importSelected: "নির্বাচিত আমদানি করুন",
    addFromMemory: "স্মৃতি থেকে যোগ করুন",
    episodicMemory: "পর্বভিত্তিক স্মৃতি",
    eventLog: "ইভেন্ট লগ",
    foresight: "পূর্বদর্শন",
    importSuccess: "স্মৃতি উৎস হিসেবে আমদানি করা হয়েছে",
    importError: "স্মৃতি আমদানি করতে ব্যর্থ",
    hubOffline: "মেমোরি হাব অফলাইনে আছে",
    importing: "স্মৃতি আমদানি করা হচ্ছে...",
    noMemories: "কোনো স্মৃতি উপলব্ধ নেই",
    noResults: "এই অনুসন্ধানের জন্য কোনো স্মৃতি পাওয়া যায়নি",
    originBrowser: "ব্রাউজার ক্যাপচার",
  ...
  settings: {
    ...
    filesHelp: "একবার আপনার ফাইল আপলোড এবং প্রক্রিয়া হওয়ার পর, সেগুলি আর প্রয়োজন নেই। বেশিরভাগ ব্যবহারকারী SaySo Notebook কে আপলোড ফোল্ডার থেকে আপলোড করা ফাইল স্বয়ংক্রিয়ভাবে মুছে ফেলার অনুমতি দিতে পারেন।",
  ...
  advanced: {
    ...
    updateAvailableDesc: "SaySo Notebook এর একটি নতুন সংস্করণ উপলব্ধ।",
    upToDate: "আপ টু ডেট",
    unknown: "অজানা",
  ...
  models: {
    ...
    defaultAssignmentsDesc: "SaySo Notebook জুড়ে বিভিন্ন কাজের জন্য কোন মডেল ব্যবহার করব তা কনফিগার করুন",
    missingRequiredModels: "প্রয়োজনীয় মডেল অনুপস্থিত: {models}। এগুলি ছাড়া SaySo Notebook সঠিকভাবে কাজ নাও করতে পারে।",
  ...
  apiKeys: {
    ...
    description: "SaySo Notebook এ AI প্রোভাইডার সক্ষম করতে ডেটাবেসে নিরাপদভাবে API কী সংরক্ষণ করুন।",
  ...
  studio: {
    title: "স্টুডিও",
    description: "আপনার উৎস থেকে বিষয়বস্তু তৈরি করুন",
    emptyState: "স্টুডিও আউটপুট এখানে প্রদর্শিত হবে।",
    emptyStateDesc: "উৎস যোগ করুন, তারপর অডিও ওভারভিউ, স্টাডি গাইড, মাইন্ড ম্যাপ এবং আরও অনেক কিছু তৈরি করতে ক্লিক করুন!",
    comingSoon: "শীঘ্রই আসছে",
    audioOverview: "অডিও ওভারভিউ",
    presentation: "উপস্থাপনা",
    videoSummary: "ভিডিও সারসংক্ষেপ",
