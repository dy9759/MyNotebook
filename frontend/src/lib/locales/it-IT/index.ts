export const itIT = {
  ...
  connectionErrors: {
    ...
    apiDesc: "Il server API di SaySo Notebook non è raggiungibile",
    ...
    docLink: "Documentazione SaySo Notebook",
  ...
  sources: {
    ...
    textType: "Testo",
    memoryType: "Memoria",
    addToNotebook: "Aggiungi al quaderno",
    searchSources: "Cerca fonti...",
    selectedCount: "{count} selezionati",
    batchAddToNotebook: "Aggiungi selezionati al quaderno",
  ...
  chat: {
    ...
    notebookChat: "Chat del quaderno",
    globalAsk: "Domanda globale",
    globalAskDesc: "Cerca in tutta la tua base di conoscenza",
  },
  searchPage: {
    askAndSearch: "Chiedi e cerca",
  ...
  memories: {
    browseTitle: "Sfoglia i ricordi",
    searchPlaceholder: "Cerca nei tuoi ricordi...",
    importSelected: "Importa selezionati",
    addFromMemory: "Aggiungi dalla memoria",
    episodicMemory: "Memoria episodica",
    eventLog: "Registro eventi",
    foresight: "Previsione",
    importSuccess: "Ricordi importati come fonti",
    importError: "Importazione dei ricordi non riuscita",
    hubOffline: "L'hub della memoria è offline",
    importing: "Importazione dei ricordi...",
    noMemories: "Nessun ricordo disponibile",
    noResults: "Nessun ricordo trovato per questa ricerca",
    originBrowser: "Cattura dal browser",
  ...
  settings: {
    ...
    filesHelp: "Una volta caricati ed elaborati, i tuoi file non sono più necessari. La maggior parte degli utenti dovrebbe permettere a SaySo Notebook di eliminare automaticamente i file caricati dalla cartella upload.",
  ...
  advanced: {
    ...
    updateAvailableDesc: "È disponibile una nuova versione di SaySo Notebook.",
    upToDate: "Aggiornato",
    unknown: "Sconosciuto",
  ...
  models: {
    ...
    defaultAssignmentsDesc: "Configura quali modelli usare per diversi scopi in SaySo Notebook",
    missingRequiredModels: "Modelli richiesti mancanti: {models}. SaySo Notebook potrebbe non funzionare correttamente senza questi.",
  ...
  apiKeys: {
    ...
    description: "Salva le chiavi API in modo sicuro nel database per abilitare i provider IA in SaySo Notebook.",
  ...
  studio: {
    title: "Studio",
    description: "Genera contenuti dalle tue fonti",
    emptyState: "Gli output dello Studio appariranno qui.",
    emptyStateDesc: "Aggiungi fonti, poi clicca per generare panoramiche audio, guide di studio, mappe mentali e altro!",
    comingSoon: "In arrivo",
    audioOverview: "Panoramica audio",
